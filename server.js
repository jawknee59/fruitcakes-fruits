...
//PATCH is able to update specific fields at specific time, but requires a little more code to ensure that it works properly, so we'll use that later
...
app.get('/fruits/:id', (req, res) => {
    ...
    Fruit.findById(id)
    // send the fruit as json upon sucess
        .then(fruit => {
